...
<div class="login-bg">
    ...
    <div class="login-card">
        ...
        <asp:Button ID="btnLogin" runat="server" Text="Login"
            CssClass="btn login-btn w-100" OnClick="btnLogin_Click" />

        <a href="register.aspx" class="login-link">Don't have an account? Sign up</a>

        <asp:Label ID="lblMsg" runat="server" CssClass="text-warning mt-2 d-block text-center"></asp:Label>
    </div>
